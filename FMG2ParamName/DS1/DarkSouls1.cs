...
namespace FMG2ParamName
{
    class DarkSouls1
    {
        ...
        private void RenameFMGs(BND3 itemFMGBND, BND3 menuFMGBND)
        {
            ...
            itemFMGBND.Files[11].Name = $@"{path}\Weapon Categorie.fmg";
            ...
            menuFMGBND.Files[3].Name = $@"{path}\In-game prompts and NPC menu tex.fmg";
            ...
            menuFMGBND.Files[10].Name = $@"{path}\Unknown Japanes.fmg";
            menuFMGBND.Files[11].Name = $@"{path}\Unknown misc entrie.fmg";
            menuFMGBND.Files[12].Name = $@"{path}\Unknown steam stuff.fmg";
            menuFMGBND.Files[13].Name = $@"{path}\Menu warnings and tex.fmg";
            menuFMGBND.Files[14].Name = $@"{path}\Online and DLC item description.fmg";
            menuFMGBND.Files[15].Name = $@"{path}\Online message tex.fmg";
            ...
            menuFMGBND.Files[21].Name = $@"{path}\DLC multiplayer messag.fmg";
            ...
            menuFMGBND.Files[26].Name = $@"{path}\Effect decriptio.fmg";
            menuFMGBND.Files[27].Name = $@"{path}\DLC ring name.fmg";
            menuFMGBND.Files[28].Name = $@"{path}\DLCand boss weapon categorie.fmg";
            menuFMGBND.Files[29].Name = $@"{path}\DLC and boss weapon name.fmg";
            menuFMGBND.Files[30].Name = $@"{path}\DLC null entrie.fmg";
